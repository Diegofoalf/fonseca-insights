          ...
          <Container className="py-12">
            ...
            >
              ...
              <Link
                ...
                onMouseOut={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = "#a8a09a")}
              >
                Ver proyectos
          ...
          <AnimateIn>
            ...
            {projects
              ...
              .map((project) => (
                ...
                >
                  <div
                    className="transition-colors duration-300 group-hover:border-[#C4845A]"
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="transition-transform duration-200 group-hover:translate-x-1 group-hover:-translate-y-1 inline-flex">
